...
const HeadingWidget = ({widget, setCurrentWidget, editing}) =>
   {
       ...
       return(<div>
...

        {
            editing &&
            <div>
                <input onChange={(e) => setCurrentWidget(
                    widget => ({...widget, text: e.target.value}))} value={widget.text}
                       className="form-control"/>
                <select onChange={(e) => setCurrentWidget(
                    widget => ({...widget, size: parseInt(e.target.value)}))} value={widget.size}
                        className="form-control">
